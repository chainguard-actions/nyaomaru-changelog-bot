 ...
 */
export function insertSection(changelog, anchor, newSection) {
    ...
    const anchorRegExp = new RegExp(`^${escapeRegExp(safeAnchor)}[^\\S\\r\\n]*(?=\\r?\\n|$)`, 'm');
 ...
 */
export function hasDuplicateVersion(content, version) {
 ...
 */
export function hasSection(content, version) {
 ...
 */
export function replaceSection(content, version, newSection) {
    ...
    const regExp = new RegExp(`^##\\s*\\[v${escapeRegExp(version)}\\][^\\n]*\\n[\\s\\S]*?(?=^##\\s*\\[|\\s*$)`, 'm');
 ...
 */
export function removeAllSections(content, version) {
