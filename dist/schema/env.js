 ...
 */
export function ensureGithubTokenRequired(dryRun, token) {
    if (dryRun)
        return;
    if (!token) {
        throw new ConfigError('GitHub authentication is required to create PR. Set GITHUB_TOKEN or GitHub App credentials.');
    }
}
