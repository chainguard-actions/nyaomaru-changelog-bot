import { SECTION_ADDED, SECTION_BREAKING_CHANGES, SECTION_CHANGED, SECTION_CHORE, SECTION_DOCS, SECTION_FIXED, SECTION_ORDER, SECTION_REVERTED, SECTION_TEST, } from '../constants/changelog.js';
import { CHORE_PREFIX_FLEX_RE, DOCS_PREFIX_FLEX_RE, FEAT_PREFIX_FLEX_RE, FIX_PREFIX_FLEX_RE, PERF_PREFIX_FLEX_RE, REFACTOR_PERF_STYLE_PREFIX_FLEX_RE, REVERT_PREFIX_FLEX_RE, TEST_PREFIX_FLEX_RE, } from '../constants/conventional.js';
import { CATEGORY_WEIGHTS, NEGATIVE_ATTENUATION_WEIGHT, SCORE_MAX, SCORE_MIN, WEAK_KEYWORD_WEIGHT, WEIGHT, WEIGHT_LEVEL, } from '../constants/category-scoring.js';
import { BREAKING_PREFIX_MARKER_RE, BUMP_OR_UPGRADE_RE, COMBO_ADD_TO_IMPROVE_RE, COMBO_FIX_BY_ADDING_RE, COMBO_REMOVE_WITHOUT_REPLACEMENT_RE, COMBO_TIGHTEN_TYPE_RE, VERSION_FROM_TO_RE, } from '../constants/scoring.js';
/**
 ...
 */
export function collectPrefixScoreDeltas(rawTitle, lowercasedTitle) {
    const deltas = {};
 ...
 */
export function applyNegativeSignalAttenuation(scores, normalizedPhrases) {
 ...
 */
export function applyComboHeuristics(scores, normalizedTitle) {
 ...
 */
export function applyDependencyBumpHeuristic(scores, normalizedTitle) {
 ...
 */
export function clampCategoryScores(scores) {
