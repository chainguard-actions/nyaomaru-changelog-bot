...
export async function buildOutputFromModelOrFallback(params, fallbackReasons) {
    const { owner, repo, version, date, prevRef, releaseRef, releaseBody, language, customInstructions, existingChangelog, commitList, prs, prMapBySha, provider, hasProviderKey, } = params;
