import { isString, isNull, isObject, define, isPrimitive, isNumber, } from 'is-kit';
 ...
 */
export const isNullable = define((value) => value == null);
/**
 ...
 */
export const isBucketName = define((section) => typeof section === 'string' &&
