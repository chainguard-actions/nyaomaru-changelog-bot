import { arrayOf as createArrayOfGuard, define, isArray as isArrayValue, isError as isErrorValue, isInstanceOf as createInstanceGuard, isNaN as isNaNValue, isNull, isNumber, isObject, isPrimitive, isSafeInteger as isSafeIntegerValue, isString, isUndefined as isUndefinedValue, oneOf, } from 'is-kit';
...
export function isInstanceOf(constructor) {
    return createInstanceGuard(constructor);
}
/**
 ...
 */
export const isRecord = define((value) => isObject(value) && !isNull(value));
/**
 ...
 */
export const isBucketName = define((section) => isString(section) && SECTION_ORDER.includes(section));
